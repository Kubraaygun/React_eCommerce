  ...
  <div className="container content">
    <div className="row">
      ...
      <div className="col-lg-5">
        ...
        &nbsp;
        <button className="btn btn-danger btn-sm rounded-0" onClick={()=>navigate(-1)}>Navigate to Products</button>
        &nbsp;
        <Link to={"/products"} className="btn btn-primary btn-sm rounded-0">Products</Link>
      </div>
    </div>
  </div>
</div>
